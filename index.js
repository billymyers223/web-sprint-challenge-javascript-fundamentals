...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(arr){
    ...
    zooAnimals.forEach(function(){
      names.push(`name: ${arr[i].animal_name}, scientific: ${arr[i].scientific_name}`);
      i++;
    });
    return names;
  }
  ...
  */
  ...
  function USApop(arr){
    const totalPop = arr.reduce(function(acc,item){
...
// console.log(cuboid.length + 'test');
...
/* 🐴🐴🐴 Step 4: Create a new object that uses CuboidMaker 🐴🐴🐴
  ...
  const cuboid = new CuboidMaker(cuboidOneObj);
...
const cuboidTwo = new CuboidMakerTwo(cuboidTwoObj);
